...
function Cart() {
  ...
  return (
    <div className='w-full bg-gray-100 p-4'>
      <div className='w-full mx-auto h-96 grid grid-cols-5 gap-8'>
        <div className='w-full h-full bg-white px-4 col-span-4 '>
          ...
          <div>
            {
              product.map((item) => {
                return <div key={item.id} className='w-full border-b-[1px] border-b-gray-400 p-4 flex items-center gap-6'>
                  <div className='w-1/5'>
